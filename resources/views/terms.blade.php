            ...
            <div class="p-8 md:p-16 space-y-12">
                ...
                <section>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="bg-[#F6F6F6] p-6 rounded-2xl">
                            ...
                            <p class="text-sm text-gray-600">We provide you with a high-quality, personalized experience, we collect specific information when you interact with our platform. These include:</p>

                            <ul class="list-disc pl-6 space-y-1 text-yellow-900 text-sm">
                                <li>Account Details: Basic information provided during registration, such as your name and contact info.</li>
                                <li>Interaction History: This includes your responses to quizzes, your chat history with our system, and the results of any stress assessments you complete.</li>
                                <li>Our Commitment to Security: We take your privacy seriously. All data collected is protected using encryption to ensure that your personal information remains private and is shielded from unauthorized access.</li>
                            </ul>

                        </div>
                        <div class="bg-[#F6F6F6] p-6 rounded-2xl">
                            <h3 class="font-bold text-[#1C1C84] mb-2">Data Usage</h3>
                            <p class="text-sm text-gray-600">The information we gather is used exclusively to enhance your experience and ensure our services are as effective as possible. Specifically, we use this data to:</p>
                            <ul class="list-disc pl-6 space-y-1 text-yellow-900 text-sm">
                                <li>Refine and improve our overall service quality.</li>
                                <li>Provide personalized suggestions and resources tailored to your unique needs.</li>
                                <li>Generate meaningful insights regarding your stress levels.</li>
                            </ul>
                            <p> Privacy Guarantee: We respect your personal boundaries. We do not sell or trade to third parties. Your data is used only for the purposes of supporting your wellness journey within our platform.</p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="border-l-4 border-yellow-400 bg-yellow-50 p-4 rounded-r-xl">
                        <h3 class="font-bold text-yellow-800 mb-2 underline">Purpose and Scope:</h3>
                        <p>The AI-driven features are intended to serve as educational resources and informational tools. They are designed to help you become more aware of your personal stress patterns and provide a starting point for self-reflection. <br> Important Limitations: To ensure you use these services safely and effectively, please keep the folowing boundaries in mind:
                        <ul class="list-disc pl-6 space-y-1 text-yellow-900 text-sm">
                            <li>Not a Medical Diagnosis: The assessments generated by our AI are not clinical diagnoses. They cannot replace the evaluation of a qualified doctor or mental health professional.</li>
                            <li>General Guidance Only: Any results or feedback should be viewed as broad suggestions rather than a definitive statement on your health.</li>
                            <li>Nature of AI Technology: While we strive to provide helpful insights, the platform cannot guarantee 100% accuracy in detectingg stress. AI interprets data based on patterns, which may not always capture the full complexity of your unique situation.</li>
                            <li>Seek Professional Advice: If you are experiencing significant distress or have concerns about your mental health, we strongly encourage you to consult with a healthcare provider.</li>
                        </ul>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-4 text-gray-700 leading-relaxed">
                        ...
                        <p>Quiz results are stored in your profile and can be reviewed at any time. You may retake assessments as often as you wish to track changes in your stress levels over time.</p>
                    </div>
                </section>

                <section>
                    <h2 class="text-2xl font-bold text-[#1C1C84] mb-4">Chatbot Interaction</h2>
                    <p class="mb-4">Our AI-driven chatbot offers a private space for you to discuss your well-being. By analyzing the tone and context of your messages, the system can identify signs of stress and offer relevant guidance. To ensure your privacy, every interaction remains strictly confidential and is protected within your secure account.</p>
